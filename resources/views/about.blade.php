...
<x-navbar />
    ...
    <section class="about-section">
      <div
        class="about-container-wrapper style2 section-padding pb-0 fix bg-white bg-about"
        style="
          background-image: url('{{ asset('/img/bg/calacattablackquartzstoneartificialstoneSL-LW5229-1JPG20209141945.jpg') }}');
        ...
        <div class="container">
          <div class="about-wrapper style2">
            <div class="row gy-5 gx-60">
              <div class="col-xl-6">
                <div
                  class="about-thumb img-custom-anim-left wow fadeInUp"
                  data-wow-delay=".3s"
                >
                  <img src="{{ asset('/img/about/abt2.webp') }}" alt="thumbshape" />

                  <!-- <div class="thumbShape1">
                    <img src="assets/images/about/abt2.png" alt="thumbshape" />
                  </div>

                  <img
                    class="thumb1"
                    src="assets/images/about/abt3.png"
                    alt="thumb"
              ...
              <div class="col-xl-6">
                <div class="about-content">
                  <div class="section-title text-start mt-70">
                    <div
                      class="subtitle text-start about-sub wow fadeInUp"
                      data-wow-delay=".5s"
                    >
                      <img
                        class="me-1"
                        src="{{ asset('/img/shape/titleShape1_1.webp') }}"
                        alt="icon"
                      />
                      ABOUT FORTEZZA QUARTZ
                    </div>
                    <h2
                      class="text-start mt-15 wow fadeInUp"
                      data-wow-delay=".3s"
                    >
                      Spirit of the Time, Crafted in Quartz
                    </h2>
                    <p class="desc wow fadeInUp" data-wow-delay=".5s">
                      Fortezza brings innovation and elegance to quartz
                      surfaces, blending natural patterns with modern design.
                    </p>
                  </div>

                  <div class="about-features" style="text-align: left">
                    <div
                      class="feature-item wow fadeInUp"
                      data-wow-delay=".2s"
                      style="margin: 20px 0 !important"
                    >
                      <h4>Customer-Oriented Excellence</h4>
                      <p>
                        We deliver top-quality products with long guarantees and
                        dedicated support.
                      </p>
                    </div>

                    <div class="feature-item wow fadeInUp" data-wow-delay=".4s">
                      <h4>Global Vision & Confidence</h4>
                      <p>
                        We compete internationally while maintaining a focus on
                  ...
                  <div
                    class="btn-wrapper style2 wow fadeInUp mt-3"
                    data-wow-delay=".8s"
                  >
          ...
          <div class="row gy-5 gx-60">
            <div class="col-xl-6">
              <div class="history-thumb">
                <img
                  src="{{ asset('/img/about/abt10.webp') }}"
                  alt="thumb"
                  height="550"
                />
              </div>
            ...
            <div class="col-xl-6">
              <div class="history-content mt-auto">
                <h2>13 Years of Quartz Innovation</h2>
                <p class="text">
                  Fortezza Quartz is
                  <strong>based in Canada and Turkey</strong>, delivering
                  premium quartz surfaces that combine elegance, durability, and
                  functionality.
                  <br />
                  With over a decade of experience, we provide high-quality
                  quartz solutions to global markets, including Middle East and UAE.
                  <br />
                  Our products feature a diverse selection of colors, finishes,
                  and designs to meet the exacting standards of residential and
    ...
    <section
      class="team-details-section section-padding fix"
      style="margin-top: -120px"
    >
      <div class="container">
        <div class="team-details-wrapper">
          <div class="work-gallery section-padding pb-0">
            <div
              class="subtitle text-start wow fadeInUp mb-5"
              data-wow-delay=".5s"
            >
              <img
                class="me-1"
            ...
            <div class="work-gallery-title">Our Work Gallery</div>
            <div class="slider-area workGallerySliderOne">
              <div
                class="swiper gt-slider"
                id="workGallerySliderOne"
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="gallery-thumb">
                      <img
                        src="{{ asset('/img/implemented/implemented-1.webp') }}"
                        alt="thumb"
                      />
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="gallery-thumb">
                      <img
                        src="{{ asset('/img/implemented/implemented-2.webp') }}"
                        alt="thumb"
                      />
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="gallery-thumb">
                      <img
                        src="{{ asset('/img/implemented/implemented-3.webp') }}"
                        alt="thumb"
                      />
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="gallery-thumb">
                      <img
                        src="{{ asset('/img/implemented/implemented-4.webp') }}"
                        alt="thumb"
                      />
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="gallery-thumb">
                      <img
                        src="{{ asset('/img/implemented/implemented-5.webp') }}"
                        alt="thumb"
                      />
                    </div>
                  </div>
...
<section class="facts-section section-padding pb-0 fix bg-theme2">
  <div class="container">
    <div class="facts-wrapper style1 text-center">
      <div class="facts-title mb-4 wow fadeInUp" data-wow-delay=".2s">
        <h2>Our Areas</h2>
      </div>

      <div class="map-container wow fadeInUp" data-wow-delay=".4s">
        <iframe
          src="https://www.google.com/maps/d/embed?mid=12UZJnHL4em6hMd9SvI-oATgiyHVMyV0&ehbc=2E312F"
          allowfullscreen=""
          loading="lazy"
          height="450"
        ></iframe>
        <!-- style="width:1600px; margin-left: -210px !important;" -->
    ...
    <section class="skills-section fix bg-theme2">
      <div
        class="skills-container-wrapper style2 section-padding fix"
        style="
          background-image: url('{{ asset('/img/bg/360_F_439521173_B3TRKK0sS7y5OZ6AvyBV1R3NI1PRRCbT.jpg') }}');
          background-size: cover;
          background-position: center;
          background-repeat: no-repeat;
        "
            ...
            <div class="row gy-3">
              <div class="col-xl-9">
                <div class="skills-content">
                  <div class="section-title text-start mt-70">
                    <div
                      class="subtitle text-start wow fadeInUp"
                      data-wow-delay=".5s"
                    >
                      <img
                        class="me-1"
                    ...
                    <h2
                      ...
                      data-wow-delay=".3s"
                    >
                      Premium Quartz Solutions for Your Space
                    </h2>
                    <p class="desc">
                      Fortezza brings innovative quartz surfaces that combine
                      natural beauty with superior durability. Our
                      customer-focused approach ensures every project meets the
                      highest standards of quality and design excellence. We
                      strive to transform spaces into timeless, elegant
                      environments that inspire and impress. With a commitment
                      to sustainability and cutting-edge technology, Fortezza
                      delivers surfaces that last a lifetime while enhancing
                      every interior
                    </p>
                  </div>
              ...
              <div class="col-xl-3">
                <div class="skills-thumb">
                  <div class="thumb1">
                    <img
                      src="{{ asset('/img/about/about-img.webp') }}"
                      alt="thumb"
                      class="test"
                      height="500"
                      width="400"
            ...
            <div class="col-xl-6">
              <div class="values-box style1 wow fadeInUp" data-wow-delay=".3s">
                ...
                <div class="content">
                  <h3>Integrity</h3>
                  <p>
                    We uphold honesty and transparency in every action, ensuring
                    trust and reliability in all we do.
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-6">
              <div class="values-box style1 wow fadeInUp" data-wow-delay=".5s">
                ...
                <div class="content">
                  <h3>Passion</h3>
                  <p>
                    We approach every challenge with energy and dedication,
                    driving excellence and inspiring those around us.
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-6">
              <div class="values-box style1 wow fadeInUp" data-wow-delay=".7s">
                ...
                <div class="content">
                  <h3>Adaptability</h3>
                  <p>
                    We embrace change and remain flexible, finding innovative
            ...
            <div class="col-xl-6">
              <div class="values-box style1 wow fadeInUp" data-wow-delay=".8s">
                ...
                <div class="content">
                  <h3>Care</h3>
                  <p>
                    We prioritize empathy and responsibility, nurturing
